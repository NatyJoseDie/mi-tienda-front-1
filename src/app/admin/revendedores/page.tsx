...
export default function RevendedorPage() {
  ...
  const cargarProductos = async () => {
    try {
      ...
      if (Array.isArray(productosData) && productosData.length > 0) {
        ...
        console.warn('No se encontraron productos o la respuesta está vacía');
        setProductos([]);
      }
    } catch (error: any) {
      ...
      const productosMock: ProductoRevendedor[] = [
        {
          ...
          descripcion: 'Taladro de alta potencia con baterías recargables',
          categoria: 'Herramientas Eléctricas',
          imagen: '',
          stock: 15,
          precio_revendedor: 85000
        },
        {
          id: '2',
          nombre: 'Destornillador Set 12 piezas',
          descripcion: 'Kit completo de destornilladores Phillips y planos',
          categoria: 'Herramientas Manuales',
          imagen: '',
          stock: 30,
          precio_revendedor: 12500
        },
        {
          id: '3',
          nombre: 'Nivel Láser Profesional',
          descripcion: 'Nivel láser autonivelante con soporte magnético',
          categoria: 'Instrumentos de Medición',
          imagen: '',
          stock: 8,
          precio_revendedor: 156000
        }
      ];
  ...
  const obtenerPorcentajeGanancia = async () => {
    try {
      ...
      setPorcentajeGanancia(0); // Valor por defecto
    } finally {
